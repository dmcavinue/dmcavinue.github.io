...
categories: ['ansible','terraform','kubernetes','docker','git','helm','flux','sops','kustomize','hcl','bash','golang',':gitops','ci/cd']
tags: ['tool:ansible','tool:terraform','tool:kubernetes','tool:docker','tool:git','tool:helm','tool:flux','tool:sops','tool:kustomize','language:hcl','language:bash','language:golang','tool:gitops','tool:ci/cd']
